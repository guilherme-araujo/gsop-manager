...
export interface ISimulationParameterRepository {
    ...
    linkSimulationParameterSimulation(SimulationParameter: SimulationParameter, simulation: Simulation):Promise<void>;
    linkSimulationParameterParameter(SimulationParameter: SimulationParameter, parameter: Parameter):Promise<void>;
}