...
export interface IPipelineProgramRepository {
    ...
    linkPipelineProgramProgram(pipelineProgram: PipelineProgram, program: Program):Promise<void>;
    linkPipelineProgramPipeline(pipelineProgram: PipelineProgram, Pipeline: Pipeline):Promise<void>;
}