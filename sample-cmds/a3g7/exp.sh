...
if [ -f "$FILE" ]; then
	...
	do
		...
		./$FILE samples 50 ephBonus 0.03 ephBonusB 0.07 ephStartRatio 0.6 ephBuildingRatio 0.6666 ephReusingRatio 0.1666 ephPopHistory 0 threads $THREADNUM cycles 5000 ephTime $EPHTIME ni 0 sampleId $i printPartials 1 rBMA 2.3333 rBMB 0.42857 bBA $BETA_A bBB $BETA_B >> a3g7.txt
